...
namespace eHotel.Areas.Admin.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,Password")] Models.Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password")] Models.Admin admin)
        {
            if (ModelState.IsValid)
            {
