    ...
    public class DbInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SystemDbContext>
    {
        ...
        protected override void Seed(SystemDbContext context)
        {
            var Role = new List<Roles>
            {
                ...
                new Roles{RoleName="Moderator"},
                new Roles{RoleName="Staff"}
            };
            ...
            {
            new Admin{UserName="Carson",Email="Admin1@gmail.com",Password=GetMD5("123456")},
            new Admin{UserName="Jonh",Email="Admin2@gmail.com",Password=GetMD5("123456")},
            new Admin{UserName="May",Email="Admin3@gmail.com",Password=GetMD5("123456")},
            };
            ...
            new Room{RoomNumber=102, Image = "~/Uploads/default.jpg", Description= "Phòng sạch sẽ!",Price= 250000, StatusId = 1, TypeId = 2 },
            ...
            new Room{RoomNumber=106, Image = "~/Uploads/default.jpg", Description= "Phòng sạch sẽ!",Price= 350000, StatusId = 1, TypeId = 1 },
            new Room{RoomNumber=107, Image = "~/Uploads/default.jpg", Description= "Phòng sạch sẽ!",Price= 150000, StatusId = 1, TypeId = 1 },
            new Room{RoomNumber=108, Image = "~/Uploads/default.jpg", Description= "Phòng sạch sẽ!",Price= 400000, StatusId = 1, TypeId = 1 },
