...
namespace eHotel.Data
{
    public class DbInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SystemDbContext>
    {
        ...
        protected override void Seed(SystemDbContext context)
        {
            ...
            {
            new Room{RoomNumber=101, Image ="~/Uploads/default.png", Description= "Phòng sạch sẽ!",Price= 200000, StatusId = 1, TypeId = 1 },
            new Room{RoomNumber=102, Image = "~/Uploads/default.png", Description= "Phòng sạch sẽ!",Price= 250000, StatusId = 2, TypeId = 2 },
            new Room{RoomNumber=103, Image = "~/Uploads/default.png", Description= "Phòng sạch sẽ!",Price= 300000, StatusId = 1, TypeId = 3 },
